    ...
    <div id="fixtures">
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<img class='match-image' src='{$row['Image']}' alt='Match Image'>";
                echo "{$row['idFixtures']} - {$row['Match']} - {$row['Date']} - {$row['Time']} - {$row['Location']} - {$row['Type']}";
                echo "</div>";
                // Display second image
                echo "<img class='second-image' src='{$row['SecondImage']}' alt='Second Image'>";
                echo "</li>";
